...
def main():
    try:
        ...
        if mysql_cnx:
            # 🔥 Fix: Removed `contacts_table` from function call
            contacts_with_events = automate_messages.sql_connection.get_contacts_for_today_events(mysql_cnx, today_month_day)
